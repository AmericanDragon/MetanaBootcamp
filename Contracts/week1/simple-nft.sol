...
contract SimpleNFT{
    //use string library for uint256
    ...
    string baseURL = "https://blockchang.com/images/";

    function mint(uint256 _tokenId) external {
        require(_owners[_tokenId]==address(0), "already minted");
        require(_tokenId< 100, "_tokenId invalid (too large)");
    ...
    function tokenURI(uint256 _tokenId) external view returns (string memory) {
        ...
        //why does this run but not toString(_tokenId)?
