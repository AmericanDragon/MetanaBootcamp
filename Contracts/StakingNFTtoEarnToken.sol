...
contract ERC721Staking is Ownable, ReentrancyGuard, Pausable {
     ...
     */
    uint256 private rewardsPerDay = 10;
        ...
        returns (uint256 _rewards)
    {
        ...
        return 
        (((((block.timestamp - staker.timeOfLastUpdate) * staker.stakedTokenIds.length)) * rewardsPerDay) / SECONDS_IN_DAY);
    }
